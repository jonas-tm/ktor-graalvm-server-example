...
-H:+ReportUnsupportedElementsAtRuntime -H:+ReportExceptionStackTraces -H:ReflectionConfigurationFiles=./reflection.json -cp ./build/libs/shadow.jar -H:Class=com.example.ApplicationKt -H:Name=graal-server
